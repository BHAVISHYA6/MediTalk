      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Track and manage your booked consultations</p>
          </div>
            ...
            {filteredAppointments.map((appt) => (
              <div key={appt._id} className="bg-white rounded-lg border border-gray-200 p-5">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    <p className="font-semibold text-gray-900">Doctor: {appt.doctorId?.name || 'Unknown'}</p>
